        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 En un mundo cada vez más digital, las organizaciones necesitan soluciones tecnológicas que respondan con rapidez, adaptabilidad y enfoque en el usuario. Esta unidad introduce los fundamentos de las metodologías ágiles, las cuales transformaron la manera en que se conciben y gestionan los proyectos de software. A partir del Manifiesto Ágil, se exploran sus valores, principios y las metodologías que permiten su implementación práctica.
              
              p #[b ¡Prepárese para descubrir cómo las metodologías ágiles pueden impulsar la colaboración, la mejora continua y el valor entregado al cliente!]
